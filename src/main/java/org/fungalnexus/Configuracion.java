...
public final class Configuracion {
    ...
    public static final double COSTO_DEFENSA_POR_COMBATE = 10.0;
    public static final double CAPACIDAD_MAXIMA_DEFENSA = 100.0;// Cuántas defensas se consumen para curar
